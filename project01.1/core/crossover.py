...
def point_crossover(parent1:Chromosome, parent2:Chromosome, p_crossover:float=1.0) -> List[int]:
...
def ordered_crossover(parent1:Chromosome, parent2:Chromosome, p_crossover:float=1.0) -> List[int]:
    assert isinstance(parent1,Chromosome) and isinstance(parent2,Chromosome) , f"parent(s) should have instance of Chromosome class"
    if np.random.rand() > p_crossover:
        return no_crossover(parent1,parent2)
    n = len(parent1.gene)
...
def partialmap_crossover(parent1:Chromosome, parent2:Chromosome, p_crossover:float=1.0) -> List[int]:
    assert isinstance(parent1,Chromosome) and isinstance(parent2,Chromosome) , f"parent(s) should have instance of Chromosome class"
    if np.random.rand() > p_crossover:
        return no_crossover(parent1,parent2)
    n = parent1.length
